...
function f7() {
   ...
   document.querySelector('.out-7').innerHTML = num1 ** num2;
}
...
function f10() {
   ...
   document.querySelector('.out-10').innerHTML = select;
}
...
function f11() {
   ...
   document.querySelector('.out-11').innerText = select;
}
