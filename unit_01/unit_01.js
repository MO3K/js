...
console.log('Добро ' + 'пожаловать ' + ' на курс'); //лишний пробел ' на курс'
...
document.querySelector('div.out-8').innerText = 'task-8';
...
let z1 = 6;
let z2 = 3;
document.querySelector('div.out-14').innerText = z1 * z2;
...
let y1 = 6;
let y2 = 3;
document.querySelector('div.out-15').innerText = y1 / y2;
...
let x1 = 'Hello';
let x2 = 5;
document.querySelector('div.out-16').innerText = x1 + x2;
...
console.log(out17);
console.dir(out17); //изначально присутствует ошибка в названии переменной "(out-17)"
