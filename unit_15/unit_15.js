...
const f6 = () => { document.querySelector('.out-6').innerHTML = new Set(a6).size }
...
const f7 = () => {
    ...
    let set_input = new Set(arr_input);

    if (arr_input.length == set_input.size && set_input.size > 6) {
        out = 1;
    }
    else {
        out = 0;
