...
function t5() {
    a5_res = a5.filter(value => typeof value == 'number' && value % 2 == 0);
    return a5_res;
}
...
function t6() {
    a6_res = a6.filter(value => typeof value == 'number' && value > 14);
    return a6_res;
}
...
function t7() {
    a7_res = a7.map(value => value.toLowerCase());
    return a7_res;
}
...
function t9() {
    a9.forEach((value, i) => a9[i] = value.toLowerCase());
    return a9;
}
...
function t10() {
    a10.forEach((value, index) => a10[index] = (value > 0) ? value : 0); //ошибка в описании "переберите массив a9"
    return a10;
}
...
function t11() {
    a11_res = a11.filter((value, index) => index % 2 == 0);
    return a11_res;
}
...
function t14() {
    return (a14.includes(a14_sym.toLowerCase()) || a14.includes(a14_sym))
}
...
function t15() {
    a15_res = a15.filter(obj => obj.pnum.length == 6);
    return a15_res;
}
