...
function f5() {
    ...
    if (out4.getAttribute('class') == "out-4 bg-orange") {
        out5.innerHTML = 'true';
    }
...
function f12() {
    ...
    new_div.innerHTML = '12';
    new_div.classList.add('bg-12');
    document.querySelector('.out-12').append(new_div);
}
...
function f13() {
    let new_div = document.createElement('div');
    new_div.innerHTML = 'pushMe';
    new_div.classList.add('bg-orange');
    document.querySelector('.out-13').append(new_div);
    new_div.onclick = f13_1;
}
...
function f18() {
    ...
    document.querySelector('.out-18').innerHTML = data_b;
}
