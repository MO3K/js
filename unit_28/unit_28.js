...
let goods = new Goods('demon', 100, 'img/1.png');
...
let goods2 = new Goods('demon2', 150, 'img/2.png');
...
let goods3 = new Goods2('demon3', 180, 'img/3.png', 3, true);
...
let valid = new Valid('email@mail.ru', '12345');
...
let valid1_2 = new Valid('email@mail.ru', '1234567');

valid1_2.validate();
console.log(valid1_2.isValid);
...
let valid3 = new Valid2('email@mail.ru', '12345678'); //наверное тут имелось в виду "...длину пароля меньше 7"
