...
document.querySelector('.div-1').onclick = function () {
    document.querySelector('.out-1').innerHTML = t1(this);
}
...
document.querySelector('.div-4').ondblclick = function () {
    document.querySelector('.out-4').innerHTML = t4(this);
}
...
const elem = document.querySelector('.div-11');

function t11(ev) {
    if (ev.type == 'mouseenter') {
        elem.firstElementChild.setAttribute('src', 'img/2.png');
    } else {
        elem.firstElementChild.setAttribute('src', 'img/1.png');
    }
}
...
function t16() {
    this.style.width = j++ + 'px';
}

// document.querySelector('.div-16').onmousemove = t16; если не закомментить, то не получится выполнить задание 17
...
function t18() {
    this.innerHTML = this.getBoundingClientRect().width + 'px';
}
...
function t19() {
    this.innerHTML = this.classList.value;
}
